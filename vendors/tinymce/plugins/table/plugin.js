...
(function () {
  ...
  var getHeight$1 = function (cell) {
    return needManualCalc()
      ...
      : getProp(cell, 'height', get$7(cell));
  };
  var getWidth = function (cell) {
    return needManualCalc()
      ? getCalculatedWidth(cell)
      : getProp(cell, 'width', get$8(cell));
  };
  ...
  var get$4 = function (editor, table) {
    if (isPercentagesForced(editor)) {
      var width = getRawWidth(editor, table.dom)
        .filter(isPercentage$1)
        .getOrThunk(function () {
  ...
  var replaceColumn = function (grid, index, comparator, substitution) {
    ...
    var targets = bind$2(rows, function (row, i) {
      var alreadyAdded =
        notStartRow(rows, i, index, comparator) ||
