...
var FullCalendar = (function (e) {
      ...
      return (
        (e.prototype.setProp = function (e, t) {
          ...
          if (e in kn)
            ...
            (t = Tn[e](t)), this.mutate({ standardProps: { publicId: t } });
          else if (e in Tn)
            (t = Tn[e](t)),
  ...
  function Qr(e, t) {
    return (
      void 0 === t && (t = 'day'), JSON.stringify({ date: Lt(e), type: t })
    );
  }
  var eo,
    to = null;
  ...
  function jo() {
    ...
    return function (r, o) {
      return (
        (t && St(t, o) && r === e) || ((e = r), (t = o), (n = Go(r, o))), n
      );
    };
  }
  function Go(e, t) {
  ...
  var Jo = (function () {
    ...
    return (
      ...
      (e.prototype.buildDateIncrement = function (e) {
        ...
        return (
          n ||
          ((t = this.props.dateAlignment) ? xt(1, t) : e || xt({ days: 1 }))
        );
      }),
          ...
          for (var m in u) {
            ...
            for (var _ = i.eventStore, T = 0, k = S.allows; T < k.length; T++) {
              var x = k[T],
                ...
                I = _.instances[m],
                N = void 0;
              if (((N = P ? new wr(t, P, I) : new wr(t, D)), !x(fr(M, t), N)))
                return !1;
            }
          }
          return !0;
    ...
    Es = (function () {
      function e(e) {
        ...
        (this.subjectEl = null),
          ...
          1 === (ms += 1) &&
            window.addEventListener('touchmove', Ss, { passive: !1 });
      }
      return (
        (e.prototype.destroy = function () {
          this.containerEl.removeEventListener(
            ...
            (ms -= 1) ||
              window.removeEventListener('touchmove', Ss, { passive: !1 });
        }),
        ...
        (e.prototype.handleMove = function (e, t) {
          if (this.isEnabled) {
            ...
            o < 0
              ...
              this.isAnimating ||
                ((this.isAnimating = !0), this.requestAnimation(Rs()));
          }
        }),
  ...
  var wl = (function () {
      ...
      return (
        ...
        (e.prototype.computeDateTop = function (e, t) {
          return (
            t || (t = ot(e)), this.computeTimeTop(xt(e.valueOf() - t.valueOf()))
          );
        }),
      ...
      return (
        ...
        (t.prototype.render = function () {
          ...
          return (
            ...
            yo(
              Xa,
              r({}, this.props, { defaultTimeFormat: Ul, extraClassNames: e })
            )
          );
        }),
        t
